            ...
            <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
                ...
                <div className="text-left md:w-1/2 space-y-6">
                    ...
                    <div className="space-x-4">
                        <button className="bg-black text-white py-3 px-9 rounded-lg shadow hover:bg-gray-800 transition">
                            Get Started →
                        </button>
                        <button className="bg-white text-black border border-gray-300 py-3 px-9 rounded-lg shadow hover:bg-gray-100 transition">
                            Watch Demo
                        </button>
                    </div>
                </div>
